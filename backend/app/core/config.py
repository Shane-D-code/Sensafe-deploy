...
class Settings(BaseSettings):
    ...
    CORS_ORIGINS: List[str] = [
        ...
        "http://100.31.117.111:3000",  # User app on network IP
        "http://100.31.117.111:3001",  # Admin dashboard on network IP
        "http://100.31.117.111:3002",  # Actual Vite port on network IP
        "http://100.31.117.111:8000",  # Backend itself
